var pluginOembedLoadLazyVideo = function() {
	var a = this.parentNode,
		b = a.children[0];
	b.src = b.dataset.src, this.remove()
};
document.addEventListener("DOMContentLoaded", function(a) {
	for (var b = document.getElementsByClassName("kirby-plugin-oembed__thumb"), c = 0; c < b.length; c++) b[c].addEventListener("click", pluginOembedLoadLazyVideo, !1)
}), ! function() {
	"use strict";
	var a = function(a) {
		var b = this;
		b.mainContainer = null, b.selector = null, b.settings = $.extend({
		...
		}, a && (a.elements || a.forcedElements || a.events) ? a : {}), b.getTargetedElements = function() {
			return b.mainContainer.find(b.selector)
		}, b.getSelector = function(a) {
			for (var b = [], c = 0; c < a.length; c++) a[c] && a[c].length && b.push(a[c]);
			return b.length ? b.join(", ") : null
		}, b.normalizeJqueryObject = function(a) {
			return a ? a instanceof jQuery ? a : $(a) : null
		}, b.killScrolling = function(a, b) {
			return b || "touchmove" !== a.type && "touchstart" !== a.type ? (a.preventDefault(), a.stopPropagation(), a.returnValue = !1, !1) : void 0
		}, b.onScroll = function(a) {
			if (a.isLegitScroll) return !0;
			var c = $(this),
				d = b.settings.forcedElements && c.is(b.settings.forcedElements),
				e = this.scrollHeight,
				f = c.outerHeight(),
				g = e - f - this.scrollTop;
			if (f >= e) return d && "touchstart" !== a.type ? b.killScrolling(a, d) : !0;
			var h = a.originalEvent.wheelDelta;
			d && "undefined" == typeof h && "touchstart" === a.type && (this.scrollTop <= 0 ? c.scrollTop(1) : 0 >= g && c.scrollTop(e - f - 1));
			var i = h > 0;
			return !i && -h > g ? (c.scrollTop(this.scrollHeight), b.killScrolling(a, d)) : i && h > this.scrollTop ? (c.scrollTop(0), b.killScrolling(a, d)) : (a.isLegitScroll = !0, !0)
		}, b.unbind = function() {
			return b.mainContainer && b.mainContainer.off(b.settings.events, b.selector, b.onScroll), b
		}, b.bind = function(a) {
			return a = b.normalizeJqueryObject(a), a && b.unbind(), b.mainContainer = a, b.mainContainer.on(b.settings.events, b.selector, b.onScroll), b
		}, b.settings.elements = b.getSelector([b.settings.elements]), b.settings.forcedElements = b.getSelector([b.settings.forcedElements]), b.selector = b.getSelector([b.settings.elements, b.settings.forcedElements])
	};
	"function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
		return a
	}) : "undefined" != typeof module && module.exports ? module.exports = a : (window.ScrollScope = a, jQuery && ! function(b) {
		b.fn.scrollScope = function(b) {
			var c = new a(b);
			return c.bind(this), c.mainContainer
		}
	}(jQuery))
}(), ! function(a, b) {
	...
	if (a.addEventListener) {
			...
			i = {
				_lazyOptimumx: function() {
					var a = function(a, b, c) {
						var d, e;
						return a && a.w ? a.w > c ? !1 : (d = 1 - a.w / c, e = b / c - 1, 0 > e - d) : !0
					};
					return function(b, c) {
						var d, e;
						for (d = b.index + 1; d < b.cands.length && (e = b.cands[d], e.w <= c || a(b.cands[d - 1], e.w, c)); d++) b.cSrcset.push(e.c), b.index = d
					}
				}()
			},
			j = function() {
				var a = function(a, b, c, d) {
					var e, f = a[d];
					f && (e = f.index, i[d](f, b), f.dirty && e == f.index || (f.cSrcset.join(", "), a.setAttribute(c, f.cSrcset.join(", ")), f.dirty = !0))
				};
				return function(b, c, d, e) {
					var f, g, h, i, j = b[e];
					if (j.width = c, j.picture && (g = b.parentNode))
						for (f = g.getElementsByTagName("source"), i = 0, h = f.length; h > i; i++) a(f[i], c, d, e);
					a(b, c, d, e)
				}
			}(),
			k = function(a) {
				var b = a.getAttribute("data-optimumx") || a.getAttribute("data-maxdpr");
				return b && (b = "auto" == b ? d.getOptimumX(a) : parseFloat(b, 10)), b
			},
			l = function() {
		...
		f.addEventListener("lazybeforeunveil", l), setTimeout(l), d = a.lazySizes && lazySizes.cfg || a.lazySizesConfig, d || (d = {}, a.lazySizesConfig = d), "function" != typeof d.getOptimumX && (d.getOptimumX = function() {
			...
			return b > 2.5 ? b *= .6 : b > 1.9 && (b *= .8), Math.min(Math.round(100 * b) / 100, 2)
		}), a.devicePixelRatio && (addEventListener("lazybeforesizes", function(a) {
			var b, c, d, e;
			a.defaultPrevented || !(b = k(a.target)) || b >= devicePixelRatio || (c = h(a.target, "_lazyOptimumx"), d = a.detail.width * b, d && (c.width || 0) < d && (e = a.detail.dataAttr ? lazySizes.cfg.srcsetAttr : "srcset", j(a.target, d, e, "_lazyOptimumx")))
		}), addEventListener("lazybeforeunveil", function(a) {
			a.target._lazyOptimumx && !a.detail.reloaded && (a.target._lazyOptimumx = null)
		}))
	}
}(window, document);
